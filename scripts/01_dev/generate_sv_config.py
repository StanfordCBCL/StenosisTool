...
# Last Modified: Thursday, 14th September 2023 2:50:34 pm
...
if __name__ == '__main__':
    ...
    parser.add_argument("-o", dest="outfile", required=True, help="The path to where the config file should go. Specify a valid filename to rename the file, otherwise a default 'config.yaml' is used.")
