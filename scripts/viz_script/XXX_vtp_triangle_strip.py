# File: vtp_triangle_strip.py
# File Created: Monday, 17th October 2022 3:12:57 pm
# Author: John Lee (jlee88@nd.edu)
# Last Modified: Saturday, 28th January 2023 3:53:06 pm
# Modified By: John Lee (jlee88@nd.edu>)
# 
#! Description:  A sample script for constructing 3D tubes around centerlines.
...
def get_ref_frame(vec):
  ...
  # if they happen to be parallel, cross with a different unit vector
...
if __name__ == "__main__":
  ...
  f.write('TRIANGLE_STRIPS %d %d\n' % (n_segments,(n_segments)*(2*n_theta+3)))
