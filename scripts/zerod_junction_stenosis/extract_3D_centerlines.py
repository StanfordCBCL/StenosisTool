...
if __name__ == '__main__':
    ...
    parser, dev, tool = create_parser(desc = 'extract 3D to centerlines (takes 40 min)')
    
    tool.add_argument('-cent', dest = 'centerlines', help = 'centerlines file')
    tool.add_argument('-vtu', dest = 'volume', help = 'vtu file of results')
    tool.add_argument('-outfile', help = 'output vtp file')
