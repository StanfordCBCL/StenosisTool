...
if __name__ == '__main__':
    ...
    parser.add_argument('-l', dest = 'last_cycle', action = 'store_true', default = False, help = 'to convert save output with last cycle only')
    ...
    rez = run_sim(solver = solver, use_steady_soltns=args.steady_sol, save_branch_results=args.branch, save_csv = args.csv, save_last = args.last_cycle, debug = True)
    if args.validate:
