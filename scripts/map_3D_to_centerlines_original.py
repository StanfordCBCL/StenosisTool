...
# Last Modified: Tuesday, 14th February 2023 1:13:57 am
...
# (Individual script that can be run on compute cluster), Does not need svInterface centerlines.
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description = 'extract 3D to centerlines (takes 1hr +)')
