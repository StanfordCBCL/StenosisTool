...
if __name__ == '__main__':
    ...
    #print(output_data)
    # Arbitrary
    nnmodel = BasicNN(input_neurons=len(input_data), output_neurons=len(output_data), hidden_layers=3, neurons_per_layer=500)
    ...
    trainer = pl.Trainer( max_epochs=1000, accelerator="gpu", default_root_dir=cur_results_folder, callbacks=[checkpoint_callback, early_stop], logger = csv_logger, log_every_n_steps=5)#, fast_dev_run=True)
